  ...
  const handleSaveReservation = async (data) => {
    try {
      if (editingReservation) {
        ...
        const r = await tripStore.addReservation(tripId, { ...data, day_id: selectedDayId || data.day_id || null })
        await tripStore.refreshDays(tripId)
