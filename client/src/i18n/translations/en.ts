const en: Record<string, string> = {
  ...
  'reservations.dropoff': 'Drop-off',
  'reservations.pickupDate': 'Pick-up date',
  'reservations.dropoffDate': 'Drop-off date',
  'reservations.pickupTime': 'Pick-up time',
  'reservations.dropoffTime': 'Drop-off time',
